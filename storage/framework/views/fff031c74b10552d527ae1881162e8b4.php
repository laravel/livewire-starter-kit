<div class="min-h-screen bg-gray-50 dark:bg-gray-900 py-6 sm:py-8">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex items-center gap-3 sm:gap-4 mb-2">
                ...
                <div class="flex items-center gap-3 sm:gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-sm sm:text-base text-gray-600 dark:text-gray-400">Modificar información de la PO <?php echo e($purchaseOrder->po_number); ?></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        ?>
        <div class="mb-6">
            <span class="inline-flex items-center px-3 py-1.5 text-sm font-semibold rounded-full <?php echo e($statusColors[$purchaseOrder->status] ?? 'bg-gray-100 text-gray-800 dark:bg-gray-700 dark:text-gray-300'); ?>">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($price_message): ?>
                        <div class="mt-4 p-4 rounded-lg <?php echo e($price_valid ? 'bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800' : 'bg-orange-50 dark:bg-orange-900/20 border border-orange-200 dark:border-orange-800'); ?>">
                            <div class="flex items-start gap-2">
                                ...
                                <div class="flex-1 min-w-0">
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($expected_price !== null): ?>
                                        <p class="mt-1 text-xs <?php echo e($price_valid ? 'text-green-600 dark:text-green-400' : 'text-orange-600 dark:text-orange-400'); ?>">
                            ...
                            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div class="min-w-0">
                                        ...
                                        <p class="text-xs text-gray-500 dark:text-gray-400 truncate"><?php echo e(basename($purchaseOrder->pdf_path)); ?></p>
                                    </div>
                                </div>
...
<?php /**PATH D:\xampp\htdocs\Laravel\Flexcon-tracker\resources\views/livewire/admin/purchase-orders/po-edit.blade.php ENDPATH**/ ?>