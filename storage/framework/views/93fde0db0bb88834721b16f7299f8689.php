    ...
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            <div class="flex items-center space-x-4">
                ...
                <div>
                    <h1 class="text-3xl font-bold text-gray-900 dark:text-white">Editar Estado de Producción</h1>
                    <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">
                        Modifica la información del estado de producción
                    </p>
                </div>
            </div>
        </div>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div class="flex items-center justify-end gap-3 pt-6 border-t border-gray-200 dark:border-gray-700">
                    <a href="<?php echo e(route('admin.production-statuses.index')); ?>"
...
</div><?php /**PATH C:\xampp\htdocs\flexcon-tracker\resources\views\livewire\admin\production-statuses\production-status-edit.blade.php ENDPATH**/ ?>