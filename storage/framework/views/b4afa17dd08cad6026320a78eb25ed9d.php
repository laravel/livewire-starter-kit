    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                <div>
                    <h1 class="text-3xl font-bold text-gray-900 dark:text-white">Crear Estado</h1>
                    <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">
                        Ingrese la información del nuevo estado
                    </p>
                </div>
                <div class="mt-4 sm:mt-0">
                    <a href="<?php echo e(route('admin.statuses-wo.index')); ?>"
...
</div><?php /**PATH C:\xampp\htdocs\flexcon-tracker\resources\views\livewire\admin\statuses-wo\status-wo-create.blade.php ENDPATH**/ ?>