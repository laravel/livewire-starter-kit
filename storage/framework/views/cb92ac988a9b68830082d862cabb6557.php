    ...
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            <div class="flex items-center space-x-4">
                ...
                <div>
                    <h1 class="text-3xl font-bold text-gray-900 dark:text-white">Editar Over Time</h1>
                    <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">
                        Actualiza la informacion del over time
                    </p>
                </div>
            </div>
        </div>
...
</div><?php /**PATH C:\xampp\htdocs\flexcon-tracker\resources\views\livewire\admin\over-times\over-time-edit.blade.php ENDPATH**/ ?>