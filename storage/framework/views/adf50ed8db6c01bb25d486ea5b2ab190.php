        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <p class="text-sm font-medium text-gray-600 dark:text-gray-400">Permisos Asignados</p>
                        <p class="text-2xl font-semibold text-gray-900 dark:text-white"><?php echo e(\Spatie\Permission\Models\Permission::whereHas('roles')->count()); ?></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 mb-8">
            <div class="p-6">
                <div class="flex flex-col sm:flex-row gap-4">
                    <div class="flex-1">
                        <label for="search" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Buscar permisos</label>
                        <div class="relative">
                            ...
                            <tr>
                                <td colspan="4" class="px-6 py-12 text-center">
                                    <div class="flex flex-col items-center">
                                        ...
                                        <h3 class="text-lg font-medium text-gray-900 dark:text-gray-100 mb-2">No hay permisos</h3>
                                        <p class="text-gray-500 dark:text-gray-400 mb-4">No se encontraron permisos que coincidan con tu búsqueda.</p>
                                        <a href="<?php echo e(route('admin.permissions.create')); ?>" 
...
</div><?php /**PATH C:\xampp\htdocs\flexcon-tracker\resources\views\livewire\admin\permissions\permission-list.blade.php ENDPATH**/ ?>