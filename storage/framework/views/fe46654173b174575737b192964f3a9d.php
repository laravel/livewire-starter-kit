        ...
        <div class="mb-8">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                ...
                <div class="mt-4 sm:mt-0">
                    <a href="<?php echo e(route('admin.lots.index')); ?>"
                    ...
                    <select wire:model.live="work_order_id" id="work_order_id"
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $workOrders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $wo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($wo->id); ?>">
                                <?php echo e($wo->wo_number); ?> - <?php echo e($wo->purchaseOrder->part->number); ?> (Pendiente: <?php echo e(number_format($wo->pending_quantity)); ?>)
                            </option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </select>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['work_order_id'];
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <!-- Selected WO Info -->
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($selectedWorkOrder): ?>
                <div class="p-4 bg-gray-50 dark:bg-gray-700 rounded-lg border border-gray-200 dark:border-gray-600">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                        <div>
                            ...
                            <p class="text-sm font-medium text-gray-900 dark:text-white"><?php echo e($selectedWorkOrder->purchaseOrder->part->number); ?></p>
                        </div>
                        <div>
                            <p class="text-xs text-gray-500 dark:text-gray-400">Cantidad Original</p>
                            <p class="text-sm font-medium text-gray-900 dark:text-white"><?php echo e(number_format($selectedWorkOrder->original_quantity)); ?></p>
                        </div>
                        <div>
                            <p class="text-xs text-gray-500 dark:text-gray-400">Enviadas</p>
                            <p class="text-sm font-medium text-green-600 dark:text-green-400"><?php echo e(number_format($selectedWorkOrder->sent_pieces)); ?></p>
                        </div>
                        <div>
                            <p class="text-xs text-gray-500 dark:text-gray-400">Pendiente</p>
                            <p class="text-sm font-medium text-orange-600 dark:text-orange-400"><?php echo e(number_format($selectedWorkOrder->pending_quantity)); ?></p>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <input type="number" wire:model="quantity" id="quantity" min="1"
                        <?php if($selectedWorkOrder): ?> max="<?php echo e($selectedWorkOrder->pending_quantity); ?>" <?php endif; ?>
                        class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg shadow-sm focus:border-blue-500 focus:ring-1 focus:ring-blue-500 dark:bg-gray-700 dark:text-white"
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($selectedWorkOrder): ?>
                        <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                            Máximo disponible: <?php echo e(number_format($selectedWorkOrder->pending_quantity)); ?> piezas
                        </p>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </div>
...
</div><?php /**PATH C:\xampp\htdocs\flexcon-tracker\resources\views\livewire\admin\lots\lot-create.blade.php ENDPATH**/ ?>