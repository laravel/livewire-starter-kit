                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $workOrders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $wo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $allLots; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lot): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <tr class="bg-gray-50 dark:bg-gray-700/20">
                                        ...
                                        <td class="px-4 py-2 text-center">
                                            <button
                                                wire:click="openQualityModal(<?php echo e($lot->id); ?>)"
                                                class="w-5 h-5 rounded <?php echo e($lotQualityColor); ?> <?php echo e($canInspectQuality ? 'hover:opacity-80 cursor-pointer' : 'cursor-not-allowed opacity-60'); ?> transition-opacity relative inline-flex items-center justify-center"
                                                title="<?php echo e($canInspectQuality ? 'Status de Calidad: ' . ucfirst($qualityStatus) : ($qualityBlockedReason ?? 'Bloqueado')); ?>"
                                            >
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$canInspectQuality): ?>
                            ...
                            <div class="p-4 pl-8 bg-gray-50 dark:bg-gray-700/20 space-y-2 border-l-2 border-gray-300 dark:border-gray-600">
                                ...
                                <div class="flex items-center justify-between pt-2 border-t border-gray-200 dark:border-gray-600">
                                    <div class="flex items-center gap-2">
                                        ...
                                        <button
                                            wire:click="openQualityModal(<?php echo e($lot->id); ?>)"
                                            class="w-6 h-6 rounded <?php echo e($lotQualityColorMobile); ?> <?php echo e($canInspectQualityMobile ? 'hover:opacity-80 cursor-pointer' : 'cursor-not-allowed opacity-60'); ?> transition-opacity relative inline-flex items-center justify-center"
                                            title="<?php echo e($canInspectQualityMobile ? 'Status de Calidad: ' . ucfirst($qualityStatusMobile) : ($qualityBlockedReasonMobile ?? 'Bloqueado')); ?>"
                                        >
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$canInspectQualityMobile): ?>
                                                <svg class="w-3 h-3 text-gray-500 dark:text-gray-400" fill="currentColor" viewBox="0 0 20 20">
                                                    <path fill-rule="evenodd" d="M5 9V7a5 5 0 0110 0v2a2 2 0 012 2v5a2 2 0 01-2 2H5a2 2 0 01-2-2v-5a2 2 0 012-2zm8-2v2H7V7a3 3 0 016 0z" clip-rule="evenodd"/>
                                                </svg>
                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($canInspectQualityMobile): ?>
                                            <span class="text-xs <?php echo e($qualityStatusMobile === 'approved' ? 'text-green-600 dark:text-green-400' : ($qualityStatusMobile === 'rejected' ? 'text-red-600 dark:text-red-400' : 'text-yellow-600 dark:text-yellow-400')); ?>">
                                                <?php echo e(ucfirst($qualityStatusMobile === 'pending' ? 'Pendiente' : ($qualityStatusMobile === 'approved' ? 'Aprobado' : 'No Aprobado'))); ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showQualityModal && $selectedLot): ?>
                    ...
                    <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">
                                    WO: <?php echo e($selectedLot->workOrder->purchaseOrder->wo ?? 'N/A'); ?> |
                                    Lote: <?php echo e($selectedLot->lot_number); ?>
                    ...
                    <div class="px-6 py-4 space-y-6">
                            ...
                            <div class="grid grid-cols-2 gap-4 text-sm">
                                <div>
                                    ...
                                    <span class="ml-2 text-gray-900 dark:text-white font-medium">
                                        <?php echo e($selectedLot->workOrder->purchaseOrder->part->number ?? 'N/A'); ?>
                                ...
                                <div>
                                    ...
                                    <span class="ml-2 text-gray-900 dark:text-white font-medium">
                                        <?php echo e(number_format($selectedLot->quantity)); ?> piezas
                                    </span>
                                </div>
                                <?php
                                    $releasedKit = $selectedLot->getReleasedKit();
                                ?>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($releasedKit): ?>
                                <div class="col-span-2">
                                    <span class="text-gray-500 dark:text-gray-400">Kit:</span>
                                    <span class="ml-2 text-green-600 dark:text-green-400 font-medium">
                                        <?php echo e($releasedKit->kit_number); ?> (Liberado)
                                    </span>
                                </div>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </div>
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-3 gap-3">
                                ...
                                <button
                                    ...
                                    class="flex flex-col items-center p-4 border-2 rounded-lg transition-all <?php echo e($qualityStatus === 'pending' ? 'border-yellow-500 bg-yellow-50 dark:bg-yellow-900/20' : 'border-gray-200 dark:border-gray-600 hover:border-gray-300 dark:hover:border-gray-500'); ?>"
                                >
                                    <div class="w-8 h-8 rounded-full bg-yellow-400 mb-2"></div>
                                    <span class="text-sm font-medium <?php echo e($qualityStatus === 'pending' ? 'text-yellow-700 dark:text-yellow-300' : 'text-gray-700 dark:text-gray-300'); ?>">
                                        Pendiente
                                    </span>
                                </button>
                                ...
                                <button
                                    ...
                                    class="flex flex-col items-center p-4 border-2 rounded-lg transition-all <?php echo e($qualityStatus === 'approved' ? 'border-green-500 bg-green-50 dark:bg-green-900/20' : 'border-gray-200 dark:border-gray-600 hover:border-gray-300 dark:hover:border-gray-500'); ?>"
                                >
                                    <div class="w-8 h-8 rounded-full bg-green-500 mb-2"></div>
                                    <span class="text-sm font-medium <?php echo e($qualityStatus === 'approved' ? 'text-green-700 dark:text-green-300' : 'text-gray-700 dark:text-gray-300'); ?>">
                                        Aprobado
                                    </span>
                                </button>
                                ...
                                <button
                                    ...
                                    class="flex flex-col items-center p-4 border-2 rounded-lg transition-all <?php echo e($qualityStatus === 'rejected' ? 'border-red-500 bg-red-50 dark:bg-red-900/20' : 'border-gray-200 dark:border-gray-600 hover:border-gray-300 dark:hover:border-gray-500'); ?>"
                                >
                                    <div class="w-8 h-8 rounded-full bg-red-500 mb-2"></div>
                                    <span class="text-sm font-medium <?php echo e($qualityStatus === 'rejected' ? 'text-red-700 dark:text-red-300' : 'text-gray-700 dark:text-gray-300'); ?>">
                                        No Aprobado
                                    </span>
                                </button>
                            </div>
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($qualityStatus === 'rejected'): ?>
                            ...
                            <textarea
                                ...
                                placeholder="<?php echo e($qualityStatus === 'rejected' ? 'Describa el motivo del rechazo...' : 'Observaciones adicionales (opcional)...'); ?>"
                            ></textarea>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($qualityStatus === 'rejected'): ?>
                            ...
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['qualityComments'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
