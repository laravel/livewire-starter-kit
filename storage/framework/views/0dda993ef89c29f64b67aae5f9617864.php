        ...
        <div class="mb-6 sm:mb-8">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div class="flex items-center gap-3 sm:gap-4">
                    ...
                    <div>
                        <h1 class="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white">Orden de Compra: <?php echo e($purchaseOrder->po_number); ?></h1>
                        <p class="text-sm sm:text-base text-gray-600 dark:text-gray-400">Detalle completo de la PO</p>
                    </div>
                </div>
                <div class="flex items-center gap-2">
                    <a href="<?php echo e(route('admin.purchase-orders.edit', $purchaseOrder)); ?>"
                        class="inline-flex items-center justify-center gap-2 px-4 py-2.5 bg-blue-600 hover:bg-blue-700 text-white text-sm font-medium rounded-lg shadow-sm transition-colors">
                ...
                <div class="p-4 sm:p-6">
                    ...
                    <dl class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                        <div>
                            ...
                            <dd class="text-sm sm:text-base text-gray-900 dark:text-white font-semibold"><?php echo e($purchaseOrder->po_number); ?></dd>
                        </div>
                        ...
                        <div class="bg-indigo-50 dark:bg-indigo-900/20 p-3 rounded-lg">
                            ...
                            <dd class="text-base sm:text-xl text-indigo-700 dark:text-indigo-300 font-bold"><?php echo e($purchaseOrder->wo ?? 'Sin asignar'); ?></dd>
                        </div>
                        ...
                        <div>
                            ...
                            <dd class="mt-1">
                                ...
                                ?>
                                <span class="px-2 py-1 text-xs font-semibold rounded-full <?php echo e($statusColors[$purchaseOrder->status] ?? 'bg-gray-100 text-gray-800 dark:bg-gray-700 dark:text-gray-300'); ?>">
                        ...
                        <div>
                            ...
                            <dd class="text-sm text-gray-900 dark:text-white">
                                <div class="font-medium"><?php echo e($purchaseOrder->part->number); ?></div>
                                <div class="text-xs text-gray-500 dark:text-gray-400 mt-1"><?php echo e($purchaseOrder->part->description); ?></div>
                            </dd>
                        </div>
                        
                        <div>
                            <dt class="text-xs sm:text-sm font-medium text-gray-500 dark:text-gray-400 mb-1">Cantidad</dt>
                            <dd class="text-sm sm:text-base text-gray-900 dark:text-white font-semibold"><?php echo e(number_format($purchaseOrder->quantity)); ?></dd>
                        </div>
                        
                        <div>
                            <dt class="text-xs sm:text-sm font-medium text-gray-500 dark:text-gray-400 mb-1">Precio Unitario</dt>
                            <dd class="text-sm sm:text-base text-gray-900 dark:text-white font-semibold">$<?php echo e(number_format($purchaseOrder->unit_price, 4)); ?></dd>
                        </div>
                        
                        <div>
                            <dt class="text-xs sm:text-sm font-medium text-gray-500 dark:text-gray-400 mb-1">Total</dt>
                            <dd class="text-sm sm:text-base text-gray-900 dark:text-white font-semibold">$<?php echo e(number_format($purchaseOrder->quantity * $purchaseOrder->unit_price, 2)); ?></dd>
                        </div>
                        
                        <div>
                            <dt class="text-xs sm:text-sm font-medium text-gray-500 dark:text-gray-400 mb-1">Fecha de PO</dt>
                            <dd class="text-sm text-gray-900 dark:text-white"><?php echo e($purchaseOrder->po_date->format('d/m/Y')); ?></dd>
                        </div>
                        
                        <div>
                            <dt class="text-xs sm:text-sm font-medium text-gray-500 dark:text-gray-400 mb-1">Fecha de Entrega</dt>
                            <dd class="text-sm text-gray-900 dark:text-white"><?php echo e($purchaseOrder->due_date->format('d/m/Y')); ?></dd>
                        </div>
                    </dl>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($purchaseOrder->comments): ?>
                        <div class="mt-6 pt-4 border-t border-gray-200 dark:border-gray-700">
                            ...
                            <dd class="text-sm text-gray-900 dark:text-white whitespace-pre-wrap"><?php echo e($purchaseOrder->comments); ?></dd>
                        </div>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                ...
                                <div class="p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                                        <div class="flex items-center gap-3">
                                            ...
                                            <div class="min-w-0">
                                                <p class="text-sm font-medium text-gray-700 dark:text-gray-300 truncate"><?php echo e(basename($purchaseOrder->pdf_path)); ?></p>
                        ...
                        <div class="p-4 rounded-lg <?php echo e($price_valid ? 'bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800' : 'bg-orange-50 dark:bg-orange-900/20 border border-orange-200 dark:border-orange-800'); ?>">
                            <div class="flex items-start gap-2">
                                ...
                                <div class="flex-1 min-w-0">
                                    <span class="text-sm <?php echo e($price_valid ? 'text-green-700 dark:text-green-300' : 'text-orange-700 dark:text-orange-300'); ?> font-medium">
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($expected_price !== null): ?>
                                        <p class="mt-2 text-xs <?php echo e($price_valid ? 'text-green-600 dark:text-green-400' : 'text-orange-600 dark:text-orange-400'); ?>">
...
<?php /**PATH D:\xampp\htdocs\Laravel\Flexcon-tracker\resources\views/livewire/admin/purchase-orders/po-show.blade.php ENDPATH**/ ?>