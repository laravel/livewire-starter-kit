            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                <div>
                    ...
                    <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">
                        <?php echo e($employee->full_name); ?> · <?php echo e($employee->number); ?>
        ...
        <div class="bg-white dark:bg-gray-800 shadow-sm rounded-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
            <form wire:submit="save" class="p-6 space-y-6">
                ...
                <div class="bg-gray-50 dark:bg-gray-900 rounded-lg p-4">
                    ...
                    <p class="mt-1 text-lg font-mono text-gray-900 dark:text-white"><?php echo e($employee->number); ?></p>
...
<?php /**PATH D:\xampp\htdocs\Laravel\Flexcon-tracker\resources\views/livewire/admin/employees/employee-edit.blade.php ENDPATH**/ ?>