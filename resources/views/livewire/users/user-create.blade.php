...
new class extends Component {
    ...
    public function saveUser(): void
    {
        ...
        // Si es supervisor y se seleccionó un área, asignar el área
        ...
        <div class="mb-8">
            <div class="flex items-center gap-4 mb-2">
                ...
                <div>
                    ...
                    <p class="text-gray-600 dark:text-gray-400">Completa la información para crear un nuevo usuario en el sistema</p>
                </div>
            </div>
        </div>
                ...
                <form wire:submit="saveUser" class="space-y-8">
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div>
                                <label for="selected_role" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Rol *</label>
                                <select 
                                    id="selected_role"
                            ...
                            <div>
                                <label for="department_id" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Departamento</label>
                                <select 
                                    id="department_id"
                            ...
                            <div>
                                <label for="area_id" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                    Área @if($selected_role === 'Supervisor') * @endif
                                </label>
                                <select 
                                    id="area_id"
                                    wire:model="area_id" 
                                    class="block w-full rounded-lg border-gray-300 dark:border-gray-600 shadow-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-gray-700 dark:text-white text-sm disabled:opacity-50 disabled:cursor-not-allowed"
                                ...
                                @if(!$department_id)
                                    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Selecciona un departamento primero</p>
                                @endif
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex justify-end gap-4 pt-6 border-t border-gray-200 dark:border-gray-700">
                        <button 
                            type="button"
                            wire:click="cancel"
                            class="px-6 py-2.5 text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-colors border border-gray-300 dark:border-gray-600"
                        >
                            Cancelar
                        </button>
