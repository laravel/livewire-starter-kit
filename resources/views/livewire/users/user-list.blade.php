...
new class extends Component {
    ...
    public function deleteUser(User $user): void
    {
        ...
        // Desasignar áreas si es supervisor
            ...
            <div class="p-6">
                <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                    ...
                    <div class="md:col-span-2">
                        <flux:field>
                            <flux:label class="text-sm font-medium text-gray-700 dark:text-gray-300">Buscar</flux:label>
                            <div class="relative">
                    ...
                    <div>
                        <flux:field>
                            <flux:label class="text-sm font-medium text-gray-700 dark:text-gray-300">Rol</flux:label>
                    ...
                    <div>
                        <flux:field>
                            <flux:label class="text-sm font-medium text-gray-700 dark:text-gray-300">Departamento</flux:label>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <div class="flex items-center justify-end gap-2">
                                        <a href="{{ route('users.edit', $user) }}" 
                                           class="inline-flex items-center px-3 py-1.5 bg-blue-100 hover:bg-blue-200 dark:bg-blue-900/30 dark:hover:bg-blue-900/50 text-blue-700 dark:text-blue-400 rounded-lg transition-colors">
                                        ...
                                        @if($user->id !== auth()->id())
                                            <button 
                                                ...
                                                class="inline-flex items-center px-3 py-1.5 bg-red-100 hover:bg-red-200 dark:bg-red-900/30 dark:hover:bg-red-900/50 text-red-700 dark:text-red-400 rounded-lg transition-colors">
                                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
