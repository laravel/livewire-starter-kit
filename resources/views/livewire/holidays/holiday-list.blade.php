    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                <div>
                    <h1 class="text-3xl font-bold text-gray-900 dark:text-white">Gestión de Días Feriados</h1>
                    <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">
                        Administra los días feriados del año
                    </p>
                </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <p class="text-sm font-medium text-gray-500 dark:text-gray-400">Total Días Feriados</p>
            ...
            <div
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <p class="text-sm font-medium text-gray-500 dark:text-gray-400">Próximos Feriados</p>
            ...
            <div
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <p class="text-sm font-medium text-gray-500 dark:text-gray-400">Feriados Pasados</p>
                        <p class="text-2xl font-semibold text-gray-900 dark:text-white">{{ App\Models\Holiday::where('date', '<', now())->count() }}</p>
                    </div>
                </div>
            </div>
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    <div class="flex space-x-2">
                                        ...
                                        <button wire:click="confirmDeletion({{ $holiday->id }})"
                        ...
                        @if ($holidays->count() === 0)
                            <tr>
                                <td colspan="4" class="px-6 py-4 text-center text-gray-500 dark:text-gray-400">
                                    No se encontraron días feriados.
                                </td>
                            </tr>
                        @endif
                    </tbody>
                                    ...
                                    <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                        ...
                                        <div class="mt-2">
                                            <p class="text-sm text-gray-500 dark:text-gray-400">
                                                ¿Está seguro de que desea eliminar este día feriado? Esta acción no se puede
                                                deshacer.
                                            </p>
                                        </div>
                                    </div>
