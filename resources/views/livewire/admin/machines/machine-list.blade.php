...
new class extends Component {
    ...
    {
        $machine = Machine::findOrFail($this->deleteId);
        $machine->delete();
    ...
    {
        $machinesQuery = Machine::with('area')->search($this->search);
        
        if (!empty($this->areaFilter)) {
            $machinesQuery->byArea($this->areaFilter);
        }
        
        if ($this->statusFilter === 'active') {
            $machinesQuery->active();
        } elseif ($this->statusFilter === 'inactive') {
            $machinesQuery->inactive();
        }
        
        $machines = $machinesQuery->orderBy($this->sortField, $this->sortDirection)
                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <div class="flex items-center justify-end space-x-2">
                                        ...
                                        <button wire:click="confirmDeletion({{ $machine->id }})" class="text-red-600 hover:text-red-900 dark:text-red-400 dark:hover:text-red-300">
                                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
