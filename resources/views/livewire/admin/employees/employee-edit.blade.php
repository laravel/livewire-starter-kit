            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                <div>
                    ...
                    <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">
                        {{ $employee->full_name }} · {{ $employee->number }}
                    </p>
                </div>
        ...
        <div class="bg-white dark:bg-gray-800 shadow-sm rounded-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
            <form wire:submit="save" class="p-6 space-y-6">
                ...
                <div class="bg-gray-50 dark:bg-gray-900 rounded-lg p-4">
                    <label class="block text-sm font-medium text-gray-500 dark:text-gray-400">Número de Empleado</label>
                    <p class="mt-1 text-lg font-mono text-gray-900 dark:text-white">{{ $employee->number }}</p>
                ...
                <div class="border-t border-gray-200 dark:border-gray-700 pt-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            @error('shift_id') <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p> @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <input wire:model="entry_date" type="date" id="entry_date"
                                class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg shadow-sm focus:border-blue-500 focus:ring-1 focus:ring-blue-500 dark:bg-gray-700 dark:text-white">
                            @error('entry_date') <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p> @enderror
                        </div>
                    </div>
                </div>
                ...
                <div class="border-t border-gray-200 dark:border-gray-700 pt-6">
                    ...
                    <div>
                        ...
                        <textarea wire:model="comments" id="comments" rows="3"
                            class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg shadow-sm focus:border-blue-500 focus:ring-1 focus:ring-blue-500 dark:bg-gray-700 dark:text-white resize-none"></textarea>
                        @error('comments') <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p> @enderror
                    </div>
                </div>
