                        ...
                        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-900 dark:divide-gray-700">
                                @foreach($part->prices as $price)
                                    <tr>
                                        <td class="px-4 py-3 text-sm text-gray-900 dark:text-white">${{ number_format($price->unit_price, 4) }}</td>
                                        <td class="px-4 py-3 text-sm text-gray-500 dark:text-gray-400">{{ $price->tier_1_999 ? '$' . number_format($price->tier_1_999, 4) : '-' }}</td>
                                        <td class="px-4 py-3 text-sm text-gray-500 dark:text-gray-400">{{ $price->tier_1000_10999 ? '$' . number_format($price->tier_1000_10999, 4) : '-' }}</td>
                                        <td class="px-4 py-3 text-sm text-gray-500 dark:text-gray-400">{{ $price->tier_11000_99999 ? '$' . number_format($price->tier_11000_99999, 4) : '-' }}</td>
                                        <td class="px-4 py-3 text-sm text-gray-500 dark:text-gray-400">{{ $price->tier_100000_plus ? '$' . number_format($price->tier_100000_plus, 4) : '-' }}</td>
                                        <td class="px-4 py-3 text-sm text-gray-500 dark:text-gray-400">{{ $price->effective_date->format('d/m/Y') }}</td>
                                        <td class="px-4 py-3">
                                            @if ($price->active)
