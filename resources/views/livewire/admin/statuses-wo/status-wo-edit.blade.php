<div class="space-y-6">
    <div class="flex items-center gap-4">
        ...
        <div>
            <h1 class="text-2xl font-semibold text-gray-900 dark:text-white">Editar estado</h1>
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Actualiza la información del estado</p>
        </div>
    </div>
    ...
    <div class="bg-white dark:bg-gray-800 border-2 border-gray-200 dark:border-gray-700 rounded-lg overflow-hidden divide-y divide-gray-200 dark:divide-gray-700">
        <form wire:submit="updateStatus" class="p-6 space-y-6">
                    <!-- Nombre -->
                    <div>
            ...
            <div class="flex items-center justify-end gap-3 pt-4 border-t border-gray-200 dark:border-gray-700">
                ...
                <button type="submit" class="inline-flex items-center gap-2 px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white text-sm font-medium rounded-md shadow-sm transition-colors">Actualizar estado</button>
            </div>
        </form>
    </div>
</div>
