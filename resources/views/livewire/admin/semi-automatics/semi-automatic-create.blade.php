<div class="space-y-6">
    ...
    <div class="flex items-center gap-4">
        ...
        <div>
            <h1 class="text-2xl font-semibold text-gray-900 dark:text-white">Nuevo Semi-automático</h1>
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Completa la información para crear un nuevo semi-automático</p>
        </div>
    </div>
