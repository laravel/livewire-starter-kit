<<<<<<<<< Temporary merge branch 1:resources/views/livewire/shifts/shift-create.blade.php <?php
...
new class extends Component {
    ...
    >>>>>>>> Temporary merge branch 2:resources/views/livewire/admin/shifts/shift-create.blade.php
    <div class="py-12">
                ...
                <div class="p-6">
                    <form wire:submit="saveShift" class="space-y-6">
                        ...
                        <div class="flex justify-end space-x-3 pt-4 border-t border-gray-200 dark:border-gray-700">
                            <<<<<<<<< Temporary merge branch 1:resources/views/livewire/shifts/shift-create.blade.php <a
                                ...
                                <a href="{{ route('admin.shifts.index') }}"
                                    ...
                                    2:resources/views/livewire/admin/shifts/shift-create.blade.php
                                    Cancelar
                                </a>
