<div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                <div>
                    ...
                    <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">
                        Modificar información de la PO {{ $purchaseOrder->po_number }}
                    </p>
                </div>
        ...
        @endphp
        <div class="mb-4">
            <span class="px-3 py-1 text-sm font-semibold rounded-full {{ $statusColors[$purchaseOrder->status] ?? 'bg-gray-100 text-gray-800' }}">
                            ...
                            <div class="flex items-center justify-between">
                                <div class="flex items-center">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-xs text-gray-500 dark:text-gray-400">{{ basename($purchaseOrder->pdf_path) }}</p>
                                    </div>
                                </div>
