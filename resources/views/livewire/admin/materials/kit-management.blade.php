            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-2 max-h-64 overflow-y-auto">
                @foreach($availableLots as $lot)
                    ...
                    <div
                        ...
                        class="flex items-center p-3 bg-white dark:bg-gray-800 border-2 rounded-lg cursor-pointer hover:bg-blue-50 dark:hover:bg-blue-900/30 transition-colors {{ $isSelected ? 'border-blue-500 bg-blue-50 dark:bg-blue-900/40 ring-1 ring-blue-500' : 'border-gray-200 dark:border-gray-700' }}"
                    >
