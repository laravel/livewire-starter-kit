                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        <div class="flex space-x-2">
                                            @if (Route::has('admin.break-times.show'))
                                                <a href="{{ route('admin.break-times.show', $breakTime) }}" class="text-indigo-600 hover:text-indigo-900 dark:text-indigo-400 dark:hover:text-indigo-300">
                                                    Ver
                                                </a>
                                            @endif
                                            @if (Route::has('admin.break-times.edit'))
                                                <a href="{{ route('admin.break-times.edit', $breakTime) }}" class="text-blue-600 hover:text-blue-900 dark:text-blue-400 dark:hover:text-blue-300">
                                                    Editar
                                                </a>
                                            @endif
