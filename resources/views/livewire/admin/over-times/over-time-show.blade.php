        ...
        <div class="mb-8">
            <div class="flex items-center justify-between">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        <h1 class="text-3xl font-bold text-gray-900 dark:text-white">{{ $overTime->name }}</h1>
                ...
                <div class="flex items-center space-x-3">
                    <a href="{{ route('admin.over-times.edit', $overTime) }}"
                       wire:navigate
                ...
                <div class="p-6">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <dd class="mt-1 text-sm text-gray-900 dark:text-white">{{ $overTime->name }}</dd>
                        </div>

                        <div>
                            <dt class="text-sm font-medium text-gray-500 dark:text-gray-400">Fecha</dt>
                            <dd class="mt-1 text-sm text-gray-900 dark:text-white">{{ $overTime->date->format('d/m/Y') }}</dd>
                        </div>
                        ...
                        <div>
                            ...
                            <dd class="mt-1 text-sm text-gray-900 dark:text-white">
                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-purple-100 text-purple-800 dark:bg-purple-900/30 dark:text-purple-400">
                                    {{ $overTime->employees_qty }} empleado{{ $overTime->employees_qty > 1 ? 's' : '' }}
                                </span>
                            </dd>
                        </div>
                    </div>
                        ...
                        <div>
                            ...
                            <dd class="mt-1 text-sm text-gray-900 dark:text-white">
                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-yellow-100 text-yellow-800 dark:bg-yellow-900/30 dark:text-yellow-400">
                                    {{ $overTime->break_minutes }} minutos
                                </span>
                            </dd>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="bg-purple-50 dark:bg-purple-900/20 rounded-lg p-4 border border-purple-200 dark:border-purple-800">
                            ...
                            <p class="mt-1 text-xs text-purple-700 dark:text-purple-400">
                                Horas-hombre totales ({{ $overTime->employees_qty }} × {{ $overTime->net_hours }})
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <dd class="mt-1 text-sm text-gray-900 dark:text-white">{{ $overTime->created_at->format('d/m/Y H:i') }}</dd>
                        </div>
                        <div>
                            <dt class="text-sm font-medium text-gray-500 dark:text-gray-400">Ultima Actualizacion</dt>
                            <dd class="mt-1 text-sm text-gray-900 dark:text-white">{{ $overTime->updated_at->format('d/m/Y H:i') }}</dd>
                        </div>
                    </div>
                </div>
            </div>
