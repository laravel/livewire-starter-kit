                            ...
                            @forelse($prices as $price)
                                <tr>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        ...
                                        <div class="text-xs text-gray-500">{{ Str::limit($price->part->description ?? '', 30) }}</div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm font-medium text-gray-900 dark:text-white">${{ number_format($price->sample_price, 4) }}</div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <span class="px-2 py-1 text-xs rounded-full 
                                            @if($price->workstation_type === 'table') bg-green-100 text-green-800
                                            @elseif($price->workstation_type === 'machine') bg-blue-100 text-blue-800
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm">
                                        <a href="{{ route('admin.prices.edit', $price) }}" class="text-blue-600 hover:text-blue-900 mr-3">Editar</a>
                                        <button wire:click="confirmDeletion({{ $price->id }})" class="text-red-600 hover:text-red-900">Eliminar</button>
                                    </td>
                                </tr>
                            @empty
                                <tr>
